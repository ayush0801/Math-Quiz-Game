...
int main()
{
    ...
    while (true)
    {
        ...
        /* Level 1 */
        {
            cout << "LEVEL 1 : Addiiton Skills ( YOU WILL GET ONLY 5 SECONDS TO SOLVE EACH QUESTION )\n-----------------------------------------------------------------------\n\n";
            Beep(0, 4000);
            for (int i = 1; i <= 5; i++)
            {
                srand(time(0));
        ...
        {
            cout << "LEVEL 2 : Subtraction Skills ( YOU HAVE ONLY 5 SECONDS TO SOLVE EACH QUESTION )\n-----------------------------------------------------------------------\n\n";
            Beep(0, 4000);
            for (int i = 1; i <= 5; i++)
            {
                srand(time(0));
        ...
        for (int Y = 1; j != 2 && Y != 2; Y++)
        {
            cout << "LEVEL 3 : Multiplication Skills ( YOU HAVE ONLY 5 SECONDS TO SOLVE EACH QUESTION )\n-----------------------------------------------------------------------\n\n";
            Beep(0, 4000);
            for (int i = 1; i <= 5; i++)
            {
                srand(time(0));
        ...
        for (int Y = 1; j != 2 && Y != 2; Y++)
        {
            ...
            cout << "LEVEL 4 : FINAL QUESTION ( YOU'LL GET 10 SECONDS FOR THIS ONE!!!!! )\n-----------------------------------------------------------------------\n\n";
            Beep(0, 4000);
            srand(time(0));
            int A = rand() % (10) + 6;
            cout << "Final Question"
